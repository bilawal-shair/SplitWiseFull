...
const AccountsScreen = ({navigation}) => {
  ...
  return (
    ...
    <View style={{height:1, backgroundColor:"lightgray", marginTop:10}}></View>

      <View style={{flexDirection:"row", marginTop:20}}>
        <FontAwesome  style={{marginLeft:25}}name="qrcode" size={35} color="black" />
        <Text  style={{marginLeft:30, marginTop:5, fontSize:18}}>Scan code</Text>
      </View>

  
      <View style={{flexDirection:"row", marginTop:35}}>
        <FontAwesome  style={{marginLeft:25}} name="diamond" size={20} color="black" />
        <Text  style={{marginLeft:30,  fontSize:18}}>Splitwise Pro</Text>
      </View>

      <Text style={{marginTop:30, marginLeft:10, fontSize:15}}>Preferences</Text>
  
      <View style={{flexDirection:"row", marginTop:35}}>
        <MaterialIcons  style={{marginLeft:25}}  name="email" size={24} color="black"  />
        <Text  style={{marginLeft:30,  fontSize:18}}>Email settings</Text>
      </View>

      <View style={{flexDirection:"row", marginTop:35, width:300}}>
        <FontAwesome  style={{marginLeft:25}}  name="bell-o" size={24} color="black" />
        <Text  style={{marginLeft:30,  fontSize:18}}>Device and push notification settings</Text>
      </View>

      <View style={{flexDirection:"row", marginTop:35, width:300}}>
        <Entypo  style={{marginLeft:25}}  Entypo name="lock" size={24} color="black" />
        <Text  style={{marginLeft:30,  fontSize:18}}>Passcode</Text>
      </View>

      <Text style={{marginTop:30, marginLeft:10, fontSize:15}}>Feedback</Text>

      <View style={{flexDirection:"row", marginTop:35, width:300}}>
        <FontAwesome  style={{marginLeft:25}}  name="star" size={24} color="black" />
        <Text  style={{marginLeft:30,  fontSize:18}}>Rate Splitwise</Text>
      </View>

      <View style={{flexDirection:"row", marginTop:35, width:300}}>
        <MaterialIcons style={{marginLeft:25}} name="contact-support" size={24} color="black" />
        <Text  style={{marginLeft:30,  fontSize:18}}>Contact Splitwise support</Text>
      </View>

      <View style={{height:1, backgroundColor:"lightgray", marginTop:40}}></View>

      <TouchableOpacity style={{flexDirection:"row", marginTop:35, width:300}} onPress={()=>navigation.navigate('Main')}>
        <MaterialCommunityIcons style={{marginLeft:25}} name="logout" size={24} color="black"  />
        <Text  style={{marginLeft:30,  fontSize:18}} >Logout</Text>
      </TouchableOpacity>
      ...
      <View style={{alignItems:"center", marginTop:40}}>
        <View style={{flexDirection:'row'}}>
          <Text>Made with  </Text>
            ...
            /> 
          <Text>  in Providence, RI, USA</Text>
        </View>
        
        <Text>Copyright {'\u00A9'} 2023 Splitwise, Inc.</Text>
        <Text>P.S. Bunnies!</Text>
        <Text style={{marginTop:10}}>Privacy Policy</Text>
        <Text style={{marginTop:10, marginBottom: 10}}>v23.4.1/694</Text>
